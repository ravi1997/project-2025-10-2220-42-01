...
static void demo_xor(std::mt19937& rng){
    ...
    Matrix X({4,2}); X(0,0)=0; X(0,1)=0; X(1,0)=0; X(1,1)=1; X(2,0)=1; X(2,1)=0; X(3,0)=1; X(3,1)=1;
    Matrix y({4,1}); y(0,0)=0; y(1,0)=1; y(2,0)=1; y(3,0)=0;
    ...
    for (std::size_t i=0;i<4;++i)
        std::cout << int(X(i,0)) << " xor " << int(X(i,1)) << " -> " << ypred(i,0) << "\n";
}
